 ...
 * 실제 a tag 가 지정된 문자열을 클릭하면 a tag 에 의해 URL 이 변화하는데
 * 만약 a tag 바깥쪽을 클릭하면 실제로 URL 변화 등이 없다.
 * <li><a href="#">text</a></li>
 *  위 구조에서 <a href="#" /><li>text</li></a> 처럼 만들 수 있지만
 * 이는 HTML5 문법 구조에 어긋나는 패턴이다.
 * 이럴때는 a tag 의 display 를 inline-block 으로 설정하고,
...
const UL = styled.ul`
  ...
  & a {
    ...
    box-shadow: 0 2px 2px 2px rgba(0, 0, 0, 0.1),
      2px 3px 3px 3px rgba(0, 0, 0, 0.1);
...
export const mainLoader = async () => {
  ...
  // return { bucketList : bucketList }; // 이름이 같아서 하나 생략
  return { bucketList };
};
